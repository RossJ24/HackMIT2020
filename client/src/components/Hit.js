...
class Hit extends React.Component {
    ...
    render() {
        ...
        <div class = "card">
            <div class = "card-body">
                <h1>You got hit on the</h1>
                <h3>{this.props.direction} side of your car</h3>
